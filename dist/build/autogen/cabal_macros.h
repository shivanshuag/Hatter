...
/* package netwire-5.0.1 */
#define VERSION_netwire "5.0.1"
#define MIN_VERSION_netwire(major1,major2,minor) (\
  (major1) <  5 || \
  (major1) == 5 && (major2) <  0 || \
  (major1) == 5 && (major2) == 0 && (minor) <= 1)

/* package sdl2-2.0.0 */
#define VERSION_sdl2 "2.0.0"
...
#define CURRENT_PACKAGE_KEY "hatte_9djrJL3xsAm8tZuCvyH4X7"
